...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,#dbeafe_0%,#eff6ff_32%,#fff7ed_100%)]">
      <AudioProvider />
      {view === 'home' && (
        <div className="mx-auto flex max-w-[1760px] justify-end px-3 pt-3 sm:px-5 lg:px-6 lg:pt-5">
      ...
      {view === 'quiz' && quizMode === 'study' && <StudyScreen />}
      {view === 'quiz' && quizMode !== 'study' && <QuizScreen />}
