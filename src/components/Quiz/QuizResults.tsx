...
export default function QuizResults() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-4 sm:px-6 lg:px-8 lg:py-8">
      <div className="rounded-[34px] border border-white/65 bg-[linear-gradient(135deg,rgba(248,250,252,0.97),rgba(239,246,255,0.98))] p-6 shadow-[0_30px_120px_rgba(15,23,42,0.12)]">
        <section className="panel-card bg-[linear-gradient(160deg,rgba(15,23,42,0.96),rgba(30,41,59,0.96))] text-white shadow-[0_24px_80px_rgba(15,23,42,0.35)]">
          ...
          <h1 className="mt-2 text-4xl font-semibold">{headline}</h1>
